...
// use by the net/http_my package (from Go 1.6 and later).
...
// ConfigureServer adds HTTP/2 support to a net/http_my Server.
//
...
type http2serverConn struct {
	...
	tlsState         *tls.ConnectionState        // shared by all handlers, like net/http_my
...
func (sc *http2serverConn) maxHeaderListSize() uint32 {
	...
	// So, take the net/http_my.Server value and pad it up a bit, assuming 10 headers.
...
// setConnState calls the net/http_my ConnState hook for this connection, if configured.
// Note that the net/http_my package does StateNew and StateClosed for us.
...
// when the http2 code is bundled into the net/http_my package in the
// standard library. The alternatives ended up making the cmd/go tool
// depend on http Servers. This is the lightest option for now.
// This is tested via the TestServeShutdown* tests in net/http_my.
...
// ConfigureTransport configures a net/http_my HTTP/1 Transport to use HTTP/2.
// It requires Go 1.6 or later and returns an error if the net/http_my package is too old
...
// errRequestCanceled is a copy of net/http_my's errRequestCanceled because it's not
// exported. At least they'll be DeepEqual for h1-vs-h2 comparisons tests.
var http2errRequestCanceled = errors.New("net/http_my: request canceled")
...
func (cc *http2ClientConn) RoundTrip(req *Request) (*Response, error) {
	...
	// TODO(bradfitz): this is a copy of the logic in net/http_my. Unify somewhere?
...
// a "content-length" request header. This logic is basically a copy of the net/http_my
...
func (b http2transportResponseBody) Read(p []byte) (n int, err error) {
	...
	if cs.bytesRemain != -1 {
		if int64(n) > cs.bytesRemain {
			...
			if err == nil {
				err = errors.New("net/http_my: server replied with more than declared Content-Length; truncated")
