...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "net/http_my_test.interestingGoroutines") ||
...
func goroutineLeaked() bool {
	...
	fmt.Fprintf(os.Stderr, "Too many goroutines running after net/http_my test(s).\n")
...
func afterTest(t testing.TB) {
	...
	badSubstring := map[string]string{
		...
		"created by net/http_my/httptest.(*Server).Start": "an httptest.Server",
