...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"net/http_my.(*Client).Get":          true,
		"net/http_my.(*Transport).RoundTrip": true,

		// Verify these don't exist:
		"net/http_my.http2Server":           false,
		"net/http_my.(*Server).Serve":       false,
		"net/http_my.(*ServeMux).ServeHTTP": false,
		"net/http_my.DefaultServeMux":       false,
	}
